...
const EditProfileScreen = props => {
    ...
    const [formState, dispatchFormState] = useReducer(formReducer, {
        inputValues: {
            ...
            age: editedProfile ? editedProfile.age : 0,
            ...
            couchStatus: editedProfile ? editedProfile.couchStatus : '',
            ...
            maxGuest: editedProfile ? editedProfile.maxGuest : 0,
            sleepingArrangement: editedProfile ? editedProfile.sleepingArrangement : '',
        },
        inputValidities: {
            ...
            couchStatus: editedProfile ? true : false,
        ...
        if (editedProfile) {
            dispatch(
                profileActions.editProfile(
                    ...
                    formState.inputValues.couchStatus,
            ...
            <View style={styles.form}>
                ...
                >
                    ...
                    <Input
                        ...
                        returnKeyType="next"
                        onInputChange={inputChangeHandler}
                        initialValue={editedProfile.age}
                        initiallyValid={!!editedProfile}
                        required
                        min={18}
                    />
                ...
                <ListItem.Accordion
                    content={
                        <>
                            <ListItem.Content>
                                <ListItem.Title style={styles.title}>My Condition</ListItem.Title>
                            </ListItem.Content>
                        </>
                    }
                ...
                >
                    ...
                    <Input
                        ...
                        returnKeyType="next"
                        onInputChange={inputChangeHandler}
                        initialValue={editedProfile ? editedProfile.maxGuest : 0}
                        initiallyValid={!!editedProfile}
                        required
                        min={0}
                    />
                    <Input
                        ...
                        returnKeyType="next"
                        onInputChange={inputChangeHandler}
                        initialValue={editedProfile ? editedProfile.sleepingArrangement : ''}
                        initiallyValid={!!editedProfile}
                        required
                    />
                </ListItem.Accordion>
                ...
                <ListItem.Accordion
                    content={
                        <>
                            <ListItem.Content>
                                <ListItem.Title style={styles.title}>My Experience</ListItem.Title>
                            </ListItem.Content>
                        </>
                    }
